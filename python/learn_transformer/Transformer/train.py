...
def main():
    ...
    parser.add_argument('-src_data', default='data/english.txt', required=False)
    parser.add_argument('-trg_data', default='data/french.txt', required=False)
    parser.add_argument('-src_lang', default='en', required=False)
    parser.add_argument('-trg_lang', default='fr', required=False)
    parser.add_argument('-no_cuda', action='store_true')
    parser.add_argument('-SGDR', action='store_true')
    parser.add_argument('-epochs', type=int, default=2)
    parser.add_argument('-d_model', type=int, default=512)
    parser.add_argument('-n_layers', type=int, default=1)  # 指定多少层encoder layer和decoder layer.
    parser.add_argument('-heads', type=int, default=1)  # 多少个header
